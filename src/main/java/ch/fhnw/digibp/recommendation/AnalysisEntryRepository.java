...
public interface AnalysisEntryRepository extends CrudRepository<AnalysisEntry, Long> {
    ...
    long countEntries(@Param("value") double value, @Param("analysisType") AnalysisType analysisType);
    ...
    List<RecommendationEntry> findRecommendation(@Param("value") double value, @Param("analysisType") AnalysisType analysisType);
